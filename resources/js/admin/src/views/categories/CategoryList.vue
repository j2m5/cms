<template>
  <v-container>
    <v-card style="margin-bottom: 10px;">
      <v-container>
        <v-text-field v-model="query" label="Введите поисковый запрос и нажмите Enter" clearable @keyup.enter="getCategories(true)" @click:clear="reset" />
      </v-container>
    </v-card>
    <v-card>
